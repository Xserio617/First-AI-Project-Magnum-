...
class ImageGenWorker(QThread):
    finished = pyqtSignal(str) # Dosya yolunu döner
    ...
    def run(self):
        try:
            ...
            if path:
                ...
                self.error.emit("Görsel oluşturulamadı (Bilinmeyen hata).")
...
class MainApp(QMainWindow):
    ...
    def send_message(self):
        ...
        if text.startswith("/img "):
            ...
            self.current_ai_bubble = self.add_bubble("🎨 *Painting...*", "assistant")
